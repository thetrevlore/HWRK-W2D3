...
describe Dessert do
  ...
  let(:ice_cream) { Dessert.new("ice_cream", 3, chef)}
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      ...
      expect(ice_cream.ingredients).to include("sugar")
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect{ice_cream.eat(7)}.to raise_error("not enough left!")
    end
  end
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(ice_cream.serve).to eq("Chef Daniel the Great Baker has made 3 ice_creams!")
    end
  end
